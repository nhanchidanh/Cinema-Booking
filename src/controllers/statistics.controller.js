...
class StatisticsController {
  ...
  async getRevenueByCustomer(req, res) {
    try {
      const query = req.query;
      const revenueByCustomer = await StatisticsService.getRevenueByCustomer(
        query
      );
  ...
  async getRevenueByPromotionLine(req, res) {
    try {
      const query = req.query;
      const revenueByPromotionLine =
        await StatisticsService.getRevenueByPromotionLine(query);
  ...
  async getRevenueByShowtime(req, res) {
    try {
      const revenueByShowtime = await StatisticsService.getRevenueByShowtime(
        req.query
      );
  ...
  async getRefundOrderDetail(req, res) {
    try {
      const refundOrderDetail = await StatisticsService.getRefundOrderDetail(
        req.query
      );
  ...
  async getTotalPercentCinema(req, res) {
    try {
      const totalPercentCinema =
        await StatisticsService.getTotalPercentCinema();
