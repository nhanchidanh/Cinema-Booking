...
import { MESSAGE_REQUIRE_NAME } from "../../utils/constants";
            ...
            <Col span={12}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: MESSAGE_REQUIRE_NAME("Tỉnh thành"),
                  },
                ]}
              >
                <Select
            ...
            <Col span={12}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: MESSAGE_REQUIRE_NAME("Quận huyện"),
                  },
                ]}
              >
                <Select
            ...
            <Col span={12}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: MESSAGE_REQUIRE_NAME("Phường xã"),
                  },
                ]}
              >
                <Select
                    ...
                    validator(rule, value) {
                      if (value !== undefined && dob) {
                        ...
                        return Promise.reject(
                          MESSAGE_REQUIRE_NAME("Ngày sinh")
                        );
                      }
                      return Promise.resolve();
                    },
