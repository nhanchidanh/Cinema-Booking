  ...
  return (
    <div className="site-card-wrapper">
      <Breadcrumb style={{ marginBottom: "1rem", marginTop: "1rem" }}>
        ...
        <Breadcrumb.Item>Biểu đồ lịch chiếu</Breadcrumb.Item>
      </Breadcrumb>
      ...
      >
        <Form form={form} style={{ display: "flex" }}>
          <Form.Item name="cinemaPick" style={{ marginBottom: "0px" }}>
            <Select
          ...
          <Form.Item name="moviePick" style={{ marginBottom: "0px" }}>
            <Select
